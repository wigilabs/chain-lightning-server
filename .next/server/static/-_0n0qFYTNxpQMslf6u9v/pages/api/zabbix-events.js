...
const handler = (req, res) => {
  ...
  superagent.get('https://insights.newrelic.com/accounts/2482859/query?query=SELECT%20*%20FROM%20ZabbixSSH').set('X-Query-Key', 'NRIQ-j7zJFckfarn9jsOB-nPscK5H6z0QCgHd').set('Accept', 'application/json').end((err, response) => {
    events = JSON.parse(response.text).results[0].events;
    console.log('events: ', events);
    events = [{
      name: 'Current Load',
  ...
  superagent.get('https://insights.newrelic.com/accounts/2482859/query?query=SELECT%20*%20FROM%20ZabbixAgent').set('X-Query-Key', 'NRIQ-j7zJFckfarn9jsOB-nPscK5H6z0QCgHd').set('Accept', 'application/json').end((err, response) => {
    events = JSON.parse(response.text).results[0].events;
    console.log('events: ', events);
    events = [{
      name: 'Current Load',
